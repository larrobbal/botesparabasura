$.socialfloating({
  ...
  buttons: [
    [
      { message: 'Telefono ', icon: 'phone', enabled: true, link: 'tel:+525546029795' },
      { message: 'E-mail ', icon: 'envelope', enabled: true, link: 'mailto:ventas@botesparabasura.com' }
    ],
    [
      { message: 'Lista ', icon: 'file alternate', enabled: true, link: 'assets/docs/lista_precios.pdf' }
    ],
    [
